...
const ManageAllOrders = () => {
   ...
   return (
      <div>
         <h2 className="mb-2 text-xl">Manage all orders</h2>
                              ...
                              <div className="flex items-center gap-2">
                                 ...
                                 {order.status === "unpaid" && (
                                    <label
                                       ...
                                       className="text-sm font-thin text-white border-0 cursor-pointer badge badge-lg badge-error"
                                    >
                                       Cancel
                                    </label>
                                 )}
                                 {order.status === "pending" && (
                                    <label
                                       ...
                                       className="text-sm font-thin text-black border-0 cursor-pointer badge badge-lg badge-info"
                                    >
                                       Ship Order
                                    </label>
                                 )}
